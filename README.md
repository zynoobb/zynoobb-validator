...
```typescript
import { isKorean, isKoreanAsync } from "@zynoob/validator";
...
```typescript
import { isEnglish, isEnglishAsync } from "@zynoobb/validator";
...
```typescript
import { isKoreanAsync } from "@zynoobb/validator";
